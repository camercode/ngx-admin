...
<html lang="en">
<head>
    <title>Code coverage report for typedoc.parser/parsers/overview.parser.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">typedoc.parser/parsers</a> overview.parser.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { CO } from '../typedoc.parser.options';
...
&nbsp;
        if (example.tag.startsWith('live-example')) {
          re<span class="missing-if-branch" title="else path not taken" >E</span>turn this.parseLiveTag(example);
        }
      });
&nbsp;
    return [
...
&nbsp;
   ...
   * inl<span class="missing-if-branch" title="if path not taken" >I</span>ine-example(some-component/some.component)
...
&nbsp;
    return {
      path,<span class="branch-1 cbranch-no" title="branch not covered" ></span>
      firstLine: +firstLine,
      lastLine: +lastLine,
    };
  }
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Mon Apr 09 2018 19:37:53 GMT+0300 (+03)
</div>
</div>
